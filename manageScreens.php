...
of the entire kennel population.</p>-->
	...
	<p class="lead">Screenings Management</p>
...
</section>	<div class="table">
	<div class="row">
	<div class="col para">Screening:<input class="lead form-control" type="text" name="screenType" value="<?php echo $screenType; ?>"></div>
	<div class="col para">Date Given <input class="form-control" type="date" name="dateScreened" value="<?php echo $dateScreened; ?>"></div>
	</div>
	<div class="row">
