...
of the entire kennel population.</p>-->
	...
	<p class="lead">Certifications Management</p>
	...
	<div class="table">
	<div class="row">
	<div class="col para">Cert Type:<input class="lead form-control" type="text" name="certType" value="<?php echo $screenType; ?>"></div>
	<div class="col para">Cert Dated: <input class="form-control" type="date" name="certDate" value="<?php echo $dateScreened; ?>"></div>
	</div>
	<div class="row">
