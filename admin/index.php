                   ...
                   <div style="padding:0;padding-right:28px;"> <button  class="navbar-toggler" 
                    ...
                    <div class="collapse navbar-collapse" data-toggle="collapse" data-target=".navbar-collapse.show" 
                       ...
                       <div class="navbar-nav">
                           		    <li class="nav-item"><a id="link1" class="nav-link" href="#l1"><div class="aButton" >Menu
                          		    <li class="nav-item"><a id="link2" class="nav-link" href="#l2"><div class="aButton" >Links
                          		    <li class="nav-item"><a id="link3" class="nav-link" href="#l3"><div class="aButton" >Categories
                          		    <li class="nav-item"><a id="link4" class="nav-link" href="#l4"><div class="aButton" >Content
                          		    <li class="nav-item"><a id="link5" class="nav-link" href="#l5"><div class="aButton" >Images
                          		    <li class="nav-item"><a id="link6" class="nav-link" href="#l6"><div class="aButton" >Campaigns
                           		    <li class="nav-item disabled"><a id="link7" class="nav-link" href="#l7"><div class="aButton" >Themes
                                    <li class="nav-item disabled"><a id="link8" class="nav-link" href="#l8"><div class="aButton" >Users
                                        </div>
...
<div class="row"><div class="col">Check all categories<br/>associated with this content.
...
for($count = 1; $count < 16; $count++) {
	...
	$chknav = 'chknav'.$count;
	if($$thissidenav != '') { 		
	printf('<p><input class="form-control" type="checkbox" style="width:18px;height:18px;"  name="%s" value="checked" />&nbsp;%s</p>',$chknav, $$thissidenav);
	}
...
echo "<div class='form-group row'><p>Delete Categories</p>";
