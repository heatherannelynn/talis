...
echo $flag;
echo "<hr>";
$sql="SELECT * FROM classifieds where siteid='".$siteid."' and delrec != 'on' and ".$i." = 'on'";
if($res11 = $mysqli->query($sql)){
	if($row11=$res11->fetch_object()){
		//echo '<div style="padding-top:120px;"></div>';
	printf("<div id='l%s' class='content'>",$i);
...
/*
		...
		//echo '<div style="padding-top:130px;"></div>';
		echo "<div id='l2' class='content'>";
		...
		//echo '<div style="padding-top:140px;"></div>';
		echo "<div id='l3' class='content'>";
		...
		//echo '<div style="padding-top:160px;"></div>';
		echo "<div id='l5' class='content'>";
		...
		//echo '<div style="padding-top:170px;"></div>';
		echo "<div id='l6' class='content'>";
		...
		//echo '<div style="padding-top:180px;"></div>';
		echo "<div id='l7' class='content'>";
		...
		//echo '<div style="padding-top:190px;"></div>';
		echo "<div id='l8' class='content'>";
